...
#define ENGINE_COOLANT_TEMP               5   // 0x05 - °C
...
#define TIMING_ADVANCE                    14  // 0x0E - ° before TDC
#define INTAKE_AIR_TEMP                   15  // 0x0F - °C
...
#define CATALYST_TEMP_BANK_1_SENSOR_1     60  // 0x3C - °C
#define CATALYST_TEMP_BANK_2_SENSOR_1     61  // 0x3D - °C
#define CATALYST_TEMP_BANK_1_SENSOR_2     62  // 0x3E - °C
#define CATALYST_TEMP_BANK_2_SENSOR_2     63  // 0x3F - °C
...
#define AMBIENT_AIR_TEMP                  70  // 0x46 - °C
#define ABS_THROTTLE_POSITION_B           71  // 0x47 - %
#define ABS_THROTTLE_POSITION_C           72  // 0x48 - %
#define ABS_THROTTLE_POSITION_D           73  // 0x49 - %
#define ABS_THROTTLE_POSITION_E           74  // 0x4A - %
#define ABS_THROTTLE_POSITION_F           75  // 0x4B - %
...
#define ENGINE_OIL_TEMP                   92  // 0x5C - °C
#define FUEL_INJECTION_TIMING             93  // 0x5D - °
...
#define ENGINE_FUEL_RATE_GS			     157  // 0x9D - L/h
#define SERVICE_02                         2
...
// Class constants
//-------------------------------------------------------------------------------------//
#define KPH_MPH_CONVERT       0.6213711922f
#define RPM_CONVERT           0.25
#define QUERY_LEN	          7
...
public:
	...
	bool begin(Stream& stream, const bool& debug = false, const uint16_t& timeout = 1000, const char& protocol = '0');
